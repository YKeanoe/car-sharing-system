<%@ Page Title="" Language="C#" MasterPageFile="~/Dashboard.Master" AutoEventWireup="true" CodeBehind="bookingadmin.aspx.cs" Inherits="car_sharing_system.Views.bookingadmin" %>
...
<div class="row">
	<div class="col-lg-8">
		<div class="panel panel-default">
			<div class="panel-heading">
				<i class="fa fa-tasks fa-fw"></i> Booking history for <asp:Label runat="server" ID="userlabel"></asp:Label>
